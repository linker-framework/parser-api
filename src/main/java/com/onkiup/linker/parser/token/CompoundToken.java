...
public interface CompoundToken<X> extends PartialToken<X>, Serializable {
  ...
  /**
   * @param position the position for which a child token should be returned
   * @return a child token from provided position
   */
  Optional<PartialToken<?>> child(int position);
